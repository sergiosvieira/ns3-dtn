...
public:
  ...
  /* sergiosvieira */
  virtual void SetTxCallbacks (Callback<void> DTNtxOkCallback, Callback<void> DTNtxFailedCallback);
  /* sergiosvieira */
...
private:
  ...
  /* sergiosvieira */
  Callback<void> m_DTNtxOkCallback;
  Callback<void> m_DTNtxFailedCallback;
  /* sergiosvieira */
